...
bpy.ops.mesh.primitive_cylinder_add(radius=0.34, depth=4.0, location=(0, 0, 2.0), vertices=9)
...
def branch(name, tip, r0=0.16):
    base = (0.62, 0, 3.5)  # near trunk top (bent); all coords real-Blender Z-up
...
def blob(name, cx, cy, cz, r, squash, material, seed, detail=0.45):
...
masses = [
    ("massL", -1.6, -0.4, 5.0, 1.9, 0.78, M["leafD"], 11),
    ("massR", 1.7, 0.5, 4.8, 2.1, 0.75, M["leaf"], 12),
    ("massT", 0.2, 0.1, 6.2, 1.8, 0.82, M["leafL"], 13),
]
...
bpy.ops.wm.save_as_mainfile(filepath="/home/ubuntu/ba/artifacts/visual/vegetation-design/blender/canopy-broadleaf-a.blend")
print("exported", OUT)
